          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-6 border-t" style={{ borderColor: "var(--theme-border)" }}>
              ...
              <div className="flex flex-wrap justify-center items-center gap-8">
                <img src="/logo1.png" alt="Logo 1" className="h-15 md:h-17 object-contain hover:opacity-100 transition-opacity duration-300 filter drop-shadow" />
                <img src="/logo2.png" alt="Logo 2" className="h-15 md:h-17 object-contain hover:opacity-100 transition-opacity duration-300 filter drop-shadow" />
                <img src="/logo3.png" alt="Logo 3" className="h-15 md:h-17 object-contain hover:opacity-100 transition-opacity duration-300 filter drop-shadow" />
                <img src="/logo4.png" alt="Logo 4" className="h-15 md:h-17 object-contain hover:opacity-100 transition-opacity duration-300 filter drop-shadow" />
              </div>
            </div>
